            ...
            <div className="flex-auto p-5">
              <div className="w-full flex flex-row justify-between gap-2">
                <div className='flex flex-col gap-1 justify-center items-start'>
                  ...
                  <p className="mb-0 text-xl font-creatodisplay block lg:hidden">${formatNumber(session?.user?.balance ?? 0)}</p>
                </div>
                <div className="flex flex-row items-center gap-x-2 px-2 text-right basis-1/3 lg:ml-0">
                  <p className="mb-0 text-4xl font-creatodisplay hidden lg:block">${formatNumber(session?.user?.balance ?? 0)}</p>
            ...
            <div className="flex-auto p-5">
              <div className="w-full flex flex-row justify-between gap-2">
                <div className='flex flex-col gap-1 justify-center items-start'>
                  ...
                  <p className="mb-0 text-xl font-creatodisplay block lg:hidden">${formatNumber(dailyAmount)}</p>
                </div>
                <div className="flex flex-row items-center gap-x-2 px-2 text-right basis-1/3 lg:ml-0">
            ...
            <div className="flex-auto p-5">
              <div className="w-full flex flex-row justify-between gap-2">
                <div className='flex flex-col gap-1 justify-center items-start'>
                  ...
                  <p className="mb-0 text-xl font-creatodisplay block lg:hidden">${formatNumber(session.user.profit)}</p>
                </div>
                <div className="flex flex-row items-center gap-x-2 px-2 text-right basis-1/3 lg:ml-0">

...
export default function Hero() {
  ...
  return (
    <main className='bg-white relative'>
      ...
      <hr className="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25" />
      <div className='w-3/4 h-auto flex items-center justify-center mx-auto my-24'>
        <div className="flex flex-col rounded-md bg-gray-50 shadow-lg text-surface shadow-secondary-1 md:flex-row">
          ...
          <div className="flex flex-col justify-start p-6">
            ...
            <p className="w-4/5 mb-4 text-xs font-cocogoose text-justify">
              ...
              <div className="flex flex-wrap items-start mb-6 gap-y-12">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/presentation?ref=njs-profile">¿Quienes Somos?</a>
                    </li>
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/bootstrap-themes/free?ref=njs-profile">Soporte</a>
                    </li>
                  </ul>
                </div>
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://blog.creative-tim.com?ref=njs-profile">Cuenta de Ahorros</a>
                    </li>
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://www.github.com/creativetimofficial?ref=njs-profile">Inversiones</a>
                    </li>
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://www.creative-tim.com/bootstrap-themes/free?ref=njs-profile">Lineas de Credito</a>
                    </li>
                  </ul>
                </div>
                <div className="w-full lg:w-4/12 px-4">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://creative-tim.com/terms?ref=njs-profile">Terminos & Condiciones</a>
                    </li>
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://creative-tim.com/privacy?ref=njs-profile">Aviso Legal</a>
                    </li>
                    <li>
                      <a className="text-gray-400 hover:text-gray-800 font-semibold block pb-2 text-sm" href="https://creative-tim.com/contact-us?ref=njs-profile">Contactanos</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-gray-200 font-semibold py-1">
                Copyright © <span id="get-current-year">2024</span><span className="text-gray-200 hover:text-gray-800"/> Tizorbank
              </div>
            </div>
          </div>
        </div>
